	...
	var App = React.createClass({displayName: "App",
	  ...
	  render: function() {
	    var componentList = this.state.lists.map(function(item) {
	      console.log(item);
	      return (
	        React.createElement(ListContainer, {title: item.listName, index: item.index, remove: this.removeList})
	      )
	    }.bind(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var
	  Firebase = __webpack_require__(152),
	  React = __webpack_require__(3),
...
/***/ function(module, exports, __webpack_require__) {
	...
	AddList = React.createClass({displayName: "AddList",
	  getInitialState: function() {
	    return {
	      listName: ''
	    }
	  ...
	  render: function() {
	    return (
	      React.createElement("div", null, 
	        ...
	        React.createElement("input", {type: "text", className: "form-control", value: this.state.listName, placeholder: "List Name", onChange: this.handleChange}), 
